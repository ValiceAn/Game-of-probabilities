(function () {
    ...
    const RU = {
        ...
        'level2.title': 'Монетный Барьер | Космический Кот',
        'level2.h1': 'Монетный Барьер',
        'level2.subtitle': 'Пройди через барьер, используя вероятность!',
        'level2.stats': 'Статистика бросков',
        'level2.total': 'Всего бросков:',
        'level2.heads': 'Орлов:',
        'level2.tails': 'Решек:',
        'level2.goal': 'Цель:',
        'level2.progress': '{heads} орлов из {goal}',
        ...
        'level2.riskLi2': 'Решка: потеряешь 1 очко',
        'level2.riskText2': 'Продолжить или остановиться?',
        'level2.riskBtn': 'Рискнуть!',
        'level2.safeBtn': 'Остановиться',
        'level2.montyTitle': 'Парадокс Монти Холла',
        'level2.montyIntro': 'Выбери дверь, за которой приз! После твоего выбора я открою одну пустую дверь.',
        'level2.continue': 'Продолжить',
        'level2.catRisk': 'Отлично! Бросай монетку, но помни о риске!',
        'level2.catSafe': 'Безопасный выбор! Бросай монетку!',
        'level2.riskWin': 'Ура! Ты рискнул и получил бонус +3 очка!',
        'level2.riskLose': 'Решка! Ты теряешь 1 очко из-за риска.',
        'level2.goalDone': 'Ура! Ты собрал нужное количество орлов! Теперь давай изучим кое-что интересное...',
        'level2.goalFail': 'О нет! Ты использовал все попытки. Попробуй ещё раз!',
        'level2.stopOffer': 'Стоп! У меня есть предложение...',
        'level2.challengeTitle': 'Вопрос на размышление',
        'level2.ch1.q': 'Какова вероятность, что следующий бросок будет орлом?',
        'level2.ch1.o1': '50%',
        'level2.ch1.o2': '70%',
        'level2.ch1.o3': 'Зависит от предыдущих бросков',
        'level2.ch1.ex': 'Каждый бросок монетки независим, вероятность орла всегда 50%!',
        'level2.ch2.q': 'Если было 5 орлов подряд, что вероятнее на 6-й бросок?',
        'level2.ch2.o1': 'Орёл',
        'level2.ch2.o2': 'Решка',
        'level2.ch2.o3': 'Одинаково',
        'level2.ch2.ex': 'Монетка не помнит предыдущие броски - это независимость событий!',
        'level2.ch3.q': 'Какова вероятность двух орлов подряд?',
        'level2.ch3.o1': '25%',
        'level2.ch3.o2': '50%',
        'level2.ch3.o3': '75%',
        'level2.ch3.ex': 'Вероятность каждого орла 50%, а двух подряд - 50% × 50% = 25%!',
        'level2.correctPrefix': 'Правильно! ',
        'level2.incorrectPrefix': 'Не совсем! ',
        'level2.montyPick': 'Выбери дверь, за которой приз! После твоего выбора я открою одну пустую.',
        'level2.montyLine1': 'Ты выбрал дверь {selected}, я открыл дверь {opened}.',
        'level2.montyLine2': 'Хочешь поменять свой выбор на оставшуюся дверь или оставить текущий выбор?',
        'level2.switchChoice': 'Поменять выбор',
        'level2.stayChoice': 'Оставить выбор',
        'level2.changed': 'поменял',
        'level2.stayed': 'оставил',
        'level2.won': 'выиграл',
        'level2.lost': 'проиграл',
        'level2.result1': 'Ты {action} свой выбор и {result}!',
        'level2.result2': 'Приз был за дверью {door}.',
        'level2.result3': 'Это демонстрация парадокса Монти Холла: смена выбора увеличивает шансы с 1/3 до 2/3!',
        'level2.reset': 'Давай попробуем ещё раз! Бросай монетку и собирай орлов.',
        'level2.complete': 'Поздравляю! Ты завершил уровень "Монетный Барьер"! Теперь ты знаешь больше о вероятности!',
